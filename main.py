...
daily_orders_df = create_daily_order_df(main_df)
...
st.header('ARTM Collection Dashboard :sparkler:')
...
ax[1].set_title("Worst Performing Prodcut", loc="center", fontsize=50)

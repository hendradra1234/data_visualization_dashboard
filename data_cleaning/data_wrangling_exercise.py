...
Original file is located at
    https://colab.research.google.com/drive/1Y-D8A0A5X0Bl7MZHBAuVt_10aCOFyJtG
"""
...
orderCsv = "https://raw.githubusercontent.com/dicodingacademy/dicoding_dataset/main/DicodingCollection/orders.csv"

customers_df = pd.read_csv("https://raw.githubusercontent.com/dicodingacademy/dicoding_dataset/main/DicodingCollection/customers.csv")
customers_df.head()

orders_df = pd.read_csv(orderCsv)
orders_df.head()
...
sns.barplot(y="frequency", x="customer_id", data=rfm_df.sort_values(by="frequency", ascending=False).head(5), palette=colors_, ax=ax[1])
ax[1].set_ylabel(None)
ax[1].set_xlabel(None)
ax[1].set_title("By Freqency", loc="center", fontsize=18)
